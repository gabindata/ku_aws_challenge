...
type Phase = 'move' | 'trash' | 'door' | 'enter' | 'inside' | 'bed' | 'transition' | 'phone-ready' | 'phone' | 'complete';
...
export class TutorialScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.walls = []; this.darkness = undefined;
    ...
    this.showGuide('WASD로 움직여보자. (방향키도 사용할 수 있어요)');
