...
형태는 **[어떻게 말했는지를 설명하는 수식어] + [유형 이름]** 입니다.
유형 이름은 배려형·신중파·실무형·돌격형처럼 "어떤 사람"으로 읽히는 말입니다.

- 좋음: "조심스러운 발화로 시작하는 배려형"
- 좋음: "상대 사정을 먼저 살피는 신중파"
- 좋음: "조건부터 정리하고 들어가는 실무형"
- 좋음: "물러서지 않고 끝까지 밀어붙이는 돌격형"
- 좋음: "돌려 말하며 여지를 남기는 완곡형"

실제로 한 말을 그대로 옮기거나 따옴표로 인용하지 않습니다.
그건 짧은 설명에서 다룹니다.

- 나쁨: "사과와 '혹시'로 여는 지원자" — 쓴 낱말을 나열한 것
- 나쁨: "조건을 한 번에 못 박는 실무형" — 앞부분이 한 일의 서술
- 나쁨: "바로 말하는 쪽", "조건을 되짚는 확답" — 밋밋하고 사람이 안 보임
